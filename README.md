# CMS 310 &ndash; Theoretical Foundations of Computer Science
...
**CMS 310 Theoretical Foundations of Computer Science**: Builds on the foundation established in Introduction to Discrete Mathematics. Topics include, but are not restricted to, combinatorics and graph theory, Boolean algebra, digital logic circuits, functional programming, models of computation, and computational complexity. Prerequisite: MAT 140.

## Learning Outcomes

At the end of this course, you will be able to:

1. Explain the relevance of theoretical computer science to other, less abstract, applications.

2. Reason about formal models of computation, including finite automata and Turing machines. Design small automata and prove results about their properties.

3. Use regular expressions. Understand the relationships and important theoretical results connecting regular expressions and finite automata.

4. Use context-free grammars to represent programming language syntax. Use parsing algorithms to analyze a program with respect to its underlying grammar.

5. Implement major components of a programming language interpreter: a lexical analyzer, recursive-descent parser, and tree-walk intepreter.

6. Use Boolean algebra to design digital logic circuits.

7. Understand the limits of computation. Explain why some problems can never be solved by any algorithm.

## Textbook

We'll use the **free** open-source *Foundations of Computation* textbook, available as a PDF [here](https://math.hws.edu/FoundationsOfComputation/). I will also assign some readings from other books and articles, including [*Crafting Interpreters*](https://craftinginterpreters.com/).
...
**How big are the teams?** In previous classes, most teams have been four or five students.
...
1. A set of about **seven homework assignments** containing a mixture of written and programming problems.
